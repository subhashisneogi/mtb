SELECT DISTINCT
    ...
    (
        ...
        INNER JOIN procurement_material_request mr 
            ON mri.material_request_id = mr.id
    ...
    (
        ...
        INNER JOIN procurement_indent i 
